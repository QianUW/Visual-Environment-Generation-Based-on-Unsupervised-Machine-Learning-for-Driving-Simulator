...
def parse_args():
    ...
    parser.add_argument('--save_freq', type=int, default=1000, help='The number of ckpt_save_freq')#保存率
    ...
    parser.add_argument('--lr', type=float, default=0.0001, help='The learning rate')#学习步长
...
def main():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        ...
        if args.phase == 'specific':
            gan.spc_test()
            print(" [*] Spc_test finished!")
